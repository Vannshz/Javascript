...
// For Search operation on table
const searchInput = document.getElementById("searchtable");

// store name elements in array-like object
const namesFromDOM = document.getElementsByClassName("table-name");
...
// For Search operation Menu
const searchInput2 = document.getElementById("itemSearch");

// store name elements in array-like object
const namesFromDOM2 = document.getElementsByClassName("item");
...
searchInput2.addEventListener("keyup", (event) => {
    ...
    for (const nameElement of namesFromDOM2) {
        // store name text and convert to lowercase
        let name = nameElement.textContent.toLowerCase();
